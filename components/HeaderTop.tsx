...
const HeaderTop = () => {
  ...
  return (
    <div className="h-10 text-white bg-slate-900 max-lg:px-5 max-lg:h-16 max-[573px]:px-0 shadow-inner border-b border-white/5">
      <div className="flex justify-between h-full max-lg:flex-col max-lg:justify-center max-lg:items-center max-w-screen-2xl mx-auto px-12 max-[573px]:px-0">
        <ul className="flex items-center h-full gap-x-5 max-[370px]:text-sm max-[370px]:gap-x-2">
          <li className="flex items-center gap-x-2 font-semibold">
            ...
            <span>8750844921</span>
          </li>
          <li className="flex items-center gap-x-2 font-semibold">
            <FaRegEnvelope className="text-amber-400 text-xl" />
            <span>kanika.singhal247@gmail.com</span>
          </li>
        </ul>
        <ul className="flex items-center gap-x-5 h-full max-[370px]:text-sm max-[370px]:gap-x-2 font-semibold">
          ...
          <li className="flex items-center">
            <Link href="/login" className="flex items-center gap-x-2 font-semibold">
              <FaRegUser className="text-amber-400" />
              <span>Login</span>
            </Link>
          </li>
          <li className="flex items-center">
